...
const AnimatedTitle = ({ text }) => {
  ...
  return (
    <motion.h1
      ...
      initial="hidden"
      animate="visible"
      className="text-center text-4xl sm:text-5xl lg:text-7xl font-bold mb-6 tracking-tight gradient-text-secondary"
    >
      {words.map((word, index) => (
        <motion.span variants={child} style={{ marginRight: '0.5rem' }} key={index} className="inline-block mr-2 text-primary">
          {word}
        </motion.span>
      ))}
    </motion.h1>
