    ...
    <div className="bg-base-100 text-base-content overflow-x-hidden">
      ...
      <div className="relative text-center container mx-auto px-4 pt-36 pb-24">
        ...
        >
          <motion.div
            variants={fadeInUp}
            className="badge badge-lg border-primary/50 bg-primary/10 text-primary p-4 mb-6 font-semibold"
          >
            SWOT DAM 3.0
          </motion.div>
          <motion.h1
          ...
          >
            Detect Threats in Milliseconds. <br />{" "}
        ...
        >
          <div className="relative rounded-2xl p-10 md:p-16 text-center overflow-hidden bg-gradient-to-r from-primary to-cyan-500 text-primary-content shadow-2xl shadow-primary/30">
            ...
            <p className="max-w-2xl mx-auto mb-8 text-primary-content/80">
              Stop reacting to data breaches and operational bottlenecks. It's
              time to proactively secure and leverage your most critical asset.
            </p>
            <motion.button
              whileHover={{
                scale: 1.05,
